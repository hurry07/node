...
CryptoStream.prototype._done = function () {
    ...
    if (this.pair.cleartext._doneFlag &&
        this.pair.encrypted._doneFlag && !this.pair._doneFlag) {
...
function SecurePair(credentials, isServer, requestCert, rejectUnauthorized, options) {
...
exports.createSecurePair = function (credentials, isServer, requestCert, rejectUnauthorized) {
